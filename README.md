...
**Getting OneShot**
 ```
 cd ~
 wget https://raw.githubusercontent.com/Vankimfc0/OneShot/master/oneshot.py
 ```
Optional: getting a list of vulnerable to pixie dust devices for highlighting in scan results:
 ```
 wget https://raw.githubusercontent.com/Vankimfc0/OneShot/master/vulnwsc.txt
 ```
## Arch Linux
**Installing requirements**
 ```
 ...
 **Getting OneShot**
 ```
 sudo wget https://raw.githubusercontent.com/Vankimfc0/OneShot/master/oneshot.py
 ```
Optional: getting a list of vulnerable to pixie dust devices for highlighting in scan results:
 ```
 sudo wget https://raw.githubusercontent.com/Vankimfc0/OneShot/master/vulnwsc.txt
 ```
...
#### Using installer
 ```
 curl -sSf https://raw.githubusercontent.com/Vankimfc0/OneShot_Termux_installer/master/installer.sh | bash
 ```
#### Manually
**Installing requirements**
 ```
...
**Getting OneShot**
 ```
 git clone --depth 1 https://github.com/Vankimfc0/oneshot OneShot
 ```
#### Running
 ```
